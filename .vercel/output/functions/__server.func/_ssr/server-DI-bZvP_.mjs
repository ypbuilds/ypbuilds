...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-DI-bZvP_.js
var server_DI_bZvP__exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Mx3QpFvz.mjs");
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_DI_bZvP__exports as t };
